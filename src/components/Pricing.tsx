...
export default function Pricing() {
  ...
  return (
    <section className="scroll-mt-20 py-12 px-6 bg-brand-light" id="pricing">
      ...
      <div className="space-y-5 animate-in fade-in slide-in-from-bottom-2 duration-300 max-w-lg mx-auto">
